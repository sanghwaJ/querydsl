...
public class QuerydslBasicTest {
    ...
    public void findUserDto() {
        ...
        List<UserDto> result = queryFactory
                // username과 UserDto의 name이 매칭이 되지 않아 null 값으로 표현됨
                // 따라서, 아래와 같이 as("name")으로 별칭을 통해 매칭을 해야 하며, ExpressionUtils도 사용 가능
    ...
    private List<Member> searchMember(String usernameCond, Integer ageCond) {
        ...
        // username이 null이 아니라는 가정 하에, 초기 값을 넣어줄 수도 있음
    ...
    public void bulkUpdate() {
        ...
        // 벌크 연산은 DB에 쿼리가 바로 나가기 때문에, 영속성 컨텍스트 초기화!!!
        em.flush();
        em.clear();
    ...
    public void sqlFunction2() {
        List<String> result = queryFactory
                ...
                .where(member.username.eq(member.username.lower())) // lower나 upper는 ANSI 표준으로 내장하고 있기 때문에, 이렇게 쓰는게 더 간편
                .fetch();
    }
}
